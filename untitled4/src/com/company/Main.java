...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        System.out.printf(choice == 1 ? "путь к файлу с текстом: " : " путь к файлу с шифром: ");
        ...
        System.out.printf(choice == 1 ? " путь к сохраняемому файлу с зашифрованным текстом: " : " путь к сохраняемому файлу с текстом: ");
